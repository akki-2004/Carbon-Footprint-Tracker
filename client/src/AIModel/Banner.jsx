          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`"Hey, I'm Dhara, your sustainability bot bro!"`} <span className="txt-rotate" data-period="1000" data-rotate='[ "Carbon Footprint Tracking", "Sustainable AI", "Real-Time Insights" ]'><span className="wrap">{text}</span></span></h1>
                <p>Story time — Millions of years later, a lost group of time travelers finally return to Earth. To their surprise, it’s still green and livable. People are healthier, using less carbon, and living cleaner lives. Thanks to ZeroCarbonX CFT and Dhara. Curious to learn how Earth pulled it off? Meet Dhara, our smart LLM bot bro, ready to explain it all..</p>
